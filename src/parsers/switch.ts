import { BlockType, Token, SyntaxError, UnhandledError, removeEmptyWords, generateAutoGeneratedFnName, convert, isNext, convertBlock, converted, indentCount } from "../convert";
import { findLastIndex } from "./functions";
import { convertRightSide, leftSpaceNoRightSpacesOperators, noLeftSpacesRightSpaceOperators, noSpacesOperators, withSpacesOperators } from "./rightSide";
